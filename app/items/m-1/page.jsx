          ...
          <div>
               <div className='flex w-full justify-center space-x-4 mt-16'>
                    ...
                    <div className='relative w-96 border-2 h-56 overflow-hidden rounded-xl'>
                         <img className={'absolute object-cover z-20 w-full h-full p-4 te-x-full'} src={slides[index]} />
                         <img className={'absolute object-cover z-20 w-full h-full p-4 '} src={slides[index1]} />
                    </div>
               ...
               <div dir='rtl' className='mt-5 mx-20 border p-5'>
                    <h1 className='text-4xl p-2'>کفش مردانه</h1>
